...
# regularInteractive
#   /home/jclau/GitHub/zona-analysis/scripts/manual_seg/02_calculate_voxel_overlap_intrarater_classic.sh >& /home/jclau/GitHub/zona-analysis/data/output_manual_seg/voxel_overlap_intrarater_classic.csv
...
do
  ...
  fslmaths $input_label_snsx32_RN_L -mul $truth_classic_path/rater-0${rater_num}_RN_L_bin.nii.gz $output_label_snsx32_RN_L_intersection
  fslmaths $input_label_snsx32_RN_L -add $truth_classic_path/rater-0${rater_num}_RN_L_bin.nii.gz -bin $output_label_snsx32_RN_L_union
  ...
  curr_truth=`fslstats $truth_classic_path/rater-0${rater_num}_RN_L_bin.nii.gz -V | cut -d' ' -f1 | xargs` 
  printf "$SUBJ,$rater_num,$session_num,RN,left,$curr_intersection,$curr_union,$curr_vol,$curr_truth\n"

  fslmaths $input_label_snsx32_RN_R -mul $truth_classic_path/rater-0${rater_num}_RN_R_bin.nii.gz $output_label_snsx32_RN_R_intersection
  fslmaths $input_label_snsx32_RN_R -add $truth_classic_path/rater-0${rater_num}_RN_R_bin.nii.gz -bin $output_label_snsx32_RN_R_union
  ...
  curr_truth=`fslstats $truth_classic_path/rater-0${rater_num}_RN_R_bin.nii.gz -V | cut -d' ' -f1 | xargs` 
  ...
  fslmaths $input_label_snsx32_STN_L -mul $truth_classic_path/rater-0${rater_num}_STN_L_bin.nii.gz $output_label_snsx32_STN_L_intersection
  fslmaths $input_label_snsx32_STN_L -add $truth_classic_path/rater-0${rater_num}_STN_L_bin.nii.gz -bin $output_label_snsx32_STN_L_union
  ...
  curr_truth=`fslstats $truth_classic_path/rater-0${rater_num}_STN_L_bin.nii.gz -V | cut -d' ' -f1 | xargs`
  printf "$SUBJ,$rater_num,$session_num,STN,left,$curr_intersection,$curr_union,$curr_vol,$curr_truth\n"

  fslmaths $input_label_snsx32_STN_R -mul $truth_classic_path/rater-0${rater_num}_STN_R_bin.nii.gz $output_label_snsx32_STN_R_intersection
  fslmaths $input_label_snsx32_STN_R -add $truth_classic_path/rater-0${rater_num}_STN_R_bin.nii.gz -bin $output_label_snsx32_STN_R_union
  ...
  curr_truth=`fslstats $truth_classic_path/rater-0${rater_num}_STN_R_bin.nii.gz -V | cut -d' ' -f1 | xargs`
